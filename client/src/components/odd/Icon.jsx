...
export default function OddIcon({ name, size = 20, color = 'currentColor', strokeWidth = 1.8 }) {
  ...
  const paths = {
    ...
    eyeOff: (
      <>
        <path d="M3 3l18 18" />
        <path d="M10.7 6.2a10 10 0 0 1 1.3-.2c6.5 0 10 7 10 7a17 17 0 0 1-3.3 4M6.1 7.4A17 17 0 0 0 2 12s3.5 7 10 7c1.6 0 3-.3 4.3-.9" />
      </>
    ),
    fire: (
      <path d="M12 3s4 4 4 8a4 4 0 0 1-8 0c0-1.5.5-2.5 1-3 .5.8 1 1.5 1.5 1.5 0-2 1.5-4 1.5-6.5Zm-2 13a3 3 0 0 1 4 0" />
    ),
    bolt: <path d="M13 3 5 14h6l-1 7 8-11h-6l1-7Z" fill={color} stroke="none" />,
    soccer: (
      <>
        <circle cx="12" cy="12" r="9" />
        <path d="m12 6 4 2.8-1.5 4.7h-5L8 8.8 12 6Z" />
        <path d="m12 6V3M16 8.8l2.8-1M14.5 13.5l1.7 2.5M9.5 13.5 7.8 16M8 8.8 5.2 7.8" />
      </>
    ),
    basket: (
      <>
        <circle cx="12" cy="12" r="9" />
        <path d="M3 12h18M12 3v18M5.5 5.5c4 3 9 3 13 0M5.5 18.5c4-3 9-3 13 0" />
      </>
    ),
    tennis: (
      <>
        <circle cx="12" cy="12" r="9" />
        <path d="M3.5 8.5c4 1 7 4 8 8M20.5 15.5c-4-1-7-4-8-8" />
      </>
    ),
    dice: (
      <>
    ...
    cards: (
      <>
        <rect x="3" y="6" width="12" height="15" rx="1.6" />
        <path d="M8 6V5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-1" />
      </>
    ),
    flag: (
      <>
    ...
    coin: (
      <>
        <circle cx="12" cy="12" r="9" />
        <path d="M14 9.5c-.6-.8-1.5-1.2-2.5-1.2-1.4 0-2.5.9-2.5 2s.9 1.5 2.5 1.8c1.6.3 2.5.7 2.5 2s-1.1 2-2.5 2c-1 0-2-.4-2.5-1.2M11.5 7v1M11.5 16v1" />
      </>
    ),
  };
  return (
