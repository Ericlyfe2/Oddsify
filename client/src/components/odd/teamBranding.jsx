...
const TEAM_LOGOS = {
  ...
  'brighton & hove albion': W + 'en/thumb/f/fd/Brighton_%26_Hove_Albion_logo.svg/96px-Brighton_%26_Hove_Albion_logo.svg.png',
  ...
  'crystal palace':      W + 'en/thumb/0/0c/Crystal_Palace_FC_logo_%282022%29.svg/96px-Crystal_Palace_FC_logo_%282022%29.svg.png',
  crystalPalace:         W + 'en/thumb/0/0c/Crystal_Palace_FC_logo_%282022%29.svg/96px-Crystal_Palace_FC_logo_%282022%29.svg.png',
  ...
  bayern:                W + 'commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/96px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png',
  'bayern munich':       W + 'commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/96px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png',
    ...
    <div style={{
      ...
      {showImg ? (
        ...
        <span style={{
          ...
          lineHeight: 1,
        }}>{brand.short || brand.initials}</span>
      )}
    </div>
  );
}
