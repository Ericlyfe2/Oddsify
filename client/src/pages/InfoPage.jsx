  ...
  return (
    <main className="page-wrap" style={{ maxWidth: 960, margin: '0 auto', padding: '32px 24px 80px' }}>
      ...
      <section id="terms" style={sectionStyle}>
        ...
        <ul style={ulStyle}>
          <li>
            Only one account is permitted per individual. Accounts may be registered using either an email address or a
            mobile phone number — the identifier provided is the sole login credential.
          </li>
          ...
          <li>
            Account credentials must be kept confidential. You are responsible for all activity carried out under your
            login.
          </li>
        </ul>
      </section>
      ...
      <section id="privacy" style={sectionStyle}>
        ...
        <p style={pStyle}>
          Sessions are secured with short-lived access tokens and rotating refresh tokens. Failed login attempts are
          rate-limited per account and per IP to deter brute-force attacks. Transport is encrypted with TLS end-to-end.
        </p>
        <p style={pStyle}>
          You can request a copy or deletion of your data at any time by contacting our support team. Data is retained
          for the period required by Ghanaian financial regulations, then permanently erased.
        </p>
      </section>
      ...
      <section id="responsible-gaming" style={sectionStyle}>
        ...
        <ul style={ulStyle}>
          <li>
            <strong>Deposit limits</strong> — daily, weekly and monthly caps you can set from your profile.
          </li>
          <li>
            <strong>Reality checks</strong> — periodic pop-ups showing time spent and net P/L.
          </li>
          <li>
            <strong>Cool-off</strong> — short breaks of 24h, 7d, or 30d you can self-trigger.
          </li>
          <li>
            <strong>Self-exclusion</strong> — see below for our permanent exclusion option.
          </li>
        </ul>
        <p style={pStyle}>
