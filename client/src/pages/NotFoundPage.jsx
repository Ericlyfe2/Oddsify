  ...
  return (
    ...
    >
      <div style={{ maxWidth: 520, width: '100%', textAlign: 'center' }}>
        ...
        <h1 style={{ margin: '4px 0 8px', fontSize: 24, fontWeight: 800, letterSpacing: '-0.01em' }}>Page not found</h1>
        <p style={{ margin: 0, fontSize: 13.5, color: 'var(--text-soft, #aaa)', lineHeight: 1.5 }}>
          We couldn't find{' '}
          <code style={{ background: 'var(--surface,#161616)', padding: '2px 6px', borderRadius: 6, fontSize: 12 }}>
            {location.pathname}
          </code>
