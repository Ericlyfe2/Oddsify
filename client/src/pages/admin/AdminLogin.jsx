      ...
      <aside className="adm-auth-art">
        ...
        <div>
          <div className="feature">
            <IconLightning size={14} /> Enterprise grade · ISO-aligned
          </div>
          <h1>The control plane for a billion-cedi sportsbook.</h1>
          <p style={{ marginBottom: 28 }}>
            One pane of glass for revenue, risk, trading, KYC, and player ops. Every action is signed, audited, and
            reversible.
          </p>
            ...
            {[
              {
                ...
                t: 'Hardened auth',
                d: '2FA, brute-force protection, session forensics.',
              },
        ...
        <div className="form-card">
          ...
          {step === 'credentials' ? (
            <form onSubmit={submitCreds} className="form-grid">
              ...
              >
                <Link to="/" style={{ color: 'var(--text-soft)' }}>
                  ← Back to site
                </Link>
                <span>
                  Have an invite link?{' '}
                  <Link to="/admin/signup" style={{ color: 'var(--text)', fontWeight: 600 }}>
                    Create your account
                  </Link>
                </span>
              </div>
            ...
            <form onSubmit={submitCode} className="form-grid">
              <div className="adm-field">
                ...
                <input
                  ...
                  autoFocus
                  style={{ letterSpacing: '.6em', textAlign: 'center', fontSize: 18, fontFamily: 'var(--ff-mono)' }}
                />
              </div>
              <button
                className="adm-btn primary"
              ...
              >
                {busy ? (
                  ...
                  <>
                    <IconKey size={16} /> Verify and sign in
                  </>
                )}
              </button>
              <button
