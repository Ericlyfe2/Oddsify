...
export default function SlipProvider({ children }) {
  ...
  const value = useMemo(() => {
    ...
    picks, open, busy, submitting, cashoutOffers, lastBet, lastBooking,
    bookingCodeLookup, lookupLoading, recentCodes, successBet,
    togglePick, removePick, clearSlip, clearLastBet, clearLastBooking,
    openSlip, closeSlip, submit, book, lookupBookingCode,
    loadFromCode, loadFromSlip, rememberCode, forgetCode, clearLookup,
    showSuccessModal, clearSuccessModal, updateCashoutOffer,
  ]);
