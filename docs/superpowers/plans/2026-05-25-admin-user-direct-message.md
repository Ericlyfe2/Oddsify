...
Run dev: `npm run dev`. In a browser, log in as a real user (seeded `demo@oddsify.gh` works). Open DevTools → Network tab. You should see `GET /api/profile/messages?limit=50` fire after login.
