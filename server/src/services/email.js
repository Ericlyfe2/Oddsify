...
export async function sendOtp(to, code, purpose = 'verify') {
  ...
  const html = `<div style="font-family:system-ui,sans-serif">
    ...
    <p style="font-size:28px;font-weight:800;letter-spacing:6px;background:#0a0d0c;color:#c5ff3d;padding:16px 24px;border-radius:12px;display:inline-block">${code}</p>
